...
variable "remote_gateway_ip_2" {
  type        = string
  description = "An second (existing) remote VPN gateway IP to connect with."
}
...
variable "remote_cidr_2" {
  type        = string
  description = "An second (existing) destination CIDR to create route from VPN."
}
