...
[![Terraform Registry](https://img.shields.io/badge/terraform-registry-623CE4?logo=terraform)](https://registry.terraform.io/modules/terraform-ibm-modules/site-to-site-vpn/ibm/latest)
...
<ul>
  ...
  <li><a href="https://github.com/terraform-ibm-modules/terraform-ibm-site-to-site-vpn/tree/main/modules">Submodules</a>
    <ul>
      <li><a href="https://github.com/terraform-ibm-modules/terraform-ibm-site-to-site-vpn/tree/main/modules/vpn_policies">vpn_policies</a></li>
      <li><a href="https://github.com/terraform-ibm-modules/terraform-ibm-site-to-site-vpn/tree/main/modules/vpn_routing">vpn_routing</a></li>
    </ul>
  </li>
  <li><a href="https://github.com/terraform-ibm-modules/terraform-ibm-site-to-site-vpn/tree/main/examples">Examples</a>
    <ul>
      <li>
        <a href="https://github.com/terraform-ibm-modules/terraform-ibm-site-to-site-vpn/tree/main/examples/multiple-vpn-connections">Multiple Connections VPN Example</a>
      ...
      <li>
        <a href="https://github.com/terraform-ibm-modules/terraform-ibm-site-to-site-vpn/tree/main/examples/single-site">Single Site VPN Example</a>
      ...
      <li>
        <a href="https://github.com/terraform-ibm-modules/terraform-ibm-site-to-site-vpn/tree/main/examples/vpc-to-vpc">VPC to VPC Example</a>
      ...
      <li>
        <a href="https://github.com/terraform-ibm-modules/terraform-ibm-site-to-site-vpn/tree/main/examples/vpc-to-vpc/existing-gateway-connection">Adding Connection to Existing VPN Gateway</a>
...
| <a name="input_resource_tags"></a> [resource\_tags](#input\_resource\_tags) | Add user resource tags to the VPN gateway and VPN routing table to help organize, track, and manage costs. [Learn more](https://cloud.ibm.com/docs/account?topic=account-tag&interface=ui#tag-types). | `list(string)` | `[]` | no |
